...
namespace ColLayers {
	...
	const uint16 DEFAULT_MASK = DEFAULT | GROUND | PLAYER | PLAYER_ATTACK | ENEMY | ENEMY_ATTACK | PLAYER_DASH;
	...
	const uint16 CEBO_GANCHO_MASK = DEFAULT | CEBO_GANCHO;
	const uint16 CEBO_MASK = CEBO_GANCHO;
}